...
final class CmsRequest implements ServerRequestInterface
{
    /**
    ...
    {
        $originalRequest = $this->originalRequest->withProtocolVersion($version);
        $request = clone $this;
    ...
    {
        return $this->originalRequest->hasHeader($name);
    }
    ...
    {
        return $this->originalRequest->getHeaderLine($name);
    }
    ...
    {
        $originalRequest = $this->originalRequest->withHeader($name, $value);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withAddedHeader($name, $value);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withoutHeader($name);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        return $this->originalRequest->getBody();
    }
    ...
    {
        $originalRequest = $this->originalRequest->withBody($body);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withRequestTarget($requestTarget);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withMethod($method);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withUri($uri, $preserveHost);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        return $this->originalRequest->getCookieParams();
    }
    ...
    {
        $originalRequest = $this->originalRequest->withCookieParams($cookies);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withQueryParams($query);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        return $this->originalRequest->getUploadedFiles();
    }
    ...
    {
        $originalRequest = $this->originalRequest->withUploadedFiles($uploadedFiles);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withParsedBody($data);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withAttribute($name, $value);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
    ...
    {
        $originalRequest = $this->originalRequest->withoutAttribute($name);
        $request = clone $this;
        $request->originalRequest = $originalRequest;
        return $request;
    }
