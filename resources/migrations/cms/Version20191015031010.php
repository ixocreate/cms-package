...
final class Version20191015031010 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('url', Types::STRING)->setLength(2048)
            ->setCustomSchemaOption('collation', 'ascii_general_ci')->setCustomSchemaOption('charset', 'ascii');
        $table->addColumn('type', Types::STRING)->setLength(50);
        $table->addColumn('pageId', UuidType::serviceName());
        $table->addColumn('middleware', Types::JSON);
