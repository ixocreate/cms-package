...
class ContainerTest extends TestCase
{
    ...
    {
        $loader = $this->createMock(StructureLoaderInterface::class);
        $loader->method('get')->willReturnMap([
            ['031117f8-9795-4e10-ace0-3a57f5d2f166', [
                ...
                'navigation' => [
                    'df37d84d-7ff2-4a3d-bf60-c62386f92783' => ['main1', 'main2'],
                    '54da0e10-bcec-4f83-bd34-339fe05dfc06' => ['main1', 'main2'],
                ],
                'children' => [
            ...
            ['4e1867a2-d396-4aab-aec6-2e4beb19103d', [
                ...
                'navigation' => [
                    'f5ce965d-530e-41d2-a605-a6b105af7fad' => ['main1'],
                    'a4ccfa7f-4681-4ab9-ad64-e8e4190d7a39' => ['main1'],
                ],
                'children' => [],
            ]],
            ['d3a88fab-1b31-45e1-ad1f-b5a4fecb01c8', [
                ...
                'navigation' => [
                    '30a92384-5223-46e1-9320-876b50e80b84' => ['main2'],
                    'a90f0508-14f5-4649-a0be-6d8a3673eb2a' => ['main2'],
                ],
                'children' => [
                    '0426274a-3e58-4fe6-9b0b-b7c2b881f01d',
                    'b888538c-b632-4c9e-88ba-b577fd041972',
                ],
            ]],
            ['0426274a-3e58-4fe6-9b0b-b7c2b881f01d', [
                ...
                'navigation' => [
                    '31e31603-fd91-4a5b-baa4-b477f72f2688' => ['main2'],
                    '36f1294b-cee3-4423-9cce-1c6800dbe859' => ['main2'],
                ],
                'children' => [],
            ]],
            ['b888538c-b632-4c9e-88ba-b577fd041972', [
                ...
                'navigation' => [
                    '804c0c88-1f9a-48ca-b9ab-b3a33d39a1b9' => ['main1'],
                    '108f98ba-2717-4f6d-95d0-a4f38cf161af' => ['main1'],
                ],
                'children' => [],
            ]],
            ['58b99ef4-47dd-4333-802d-cb30b21d4412', [
                ...
                'navigation' => [
                    'fd500189-1099-4a3a-87f5-ed05906dd5c5' => ['main1'],
                    '4f167e6d-9822-4524-84a7-0cbf38829b6b' => ['main1'],
                ],
                'children' => [],
            ]],
            ['2b110284-d3c0-49e0-8d0a-9364463f0f81', [
                ...
                'navigation' => [
                    '7accd01e-e7e2-4349-8f29-790bc7a16196' => ['main1'],
                    '258724f4-aa0f-41b9-861f-2e32d51eef29' => ['main1'],
                ],
                'children' => [],
            ]],
        ]);
        ...
        return [
            new StructureItem('031117f8-9795-4e10-ace0-3a57f5d2f166', $loader),
        ];
    }
    ...
    private function getDefaultContainer(): Container
    {
        ...
        $cacheManager = new CacheManager($this->mockContainerInterface());
        ...
        $itemFactory = new ItemFactory(
            ...
            new PageRoute(
                ...
                new CmsRouter(
                    ...
                    $applicationUri,
                    $cacheManager,
                    $this->createMock(CompiledGeneratorRoutesCacheable::class),
                    $this->createMock(CompiledMatcherRoutesCacheable::class),
                    $this->createMock(RouteMatchRepository::class)
                ),
                $applicationUri
            )
        );

        return new Container($this->generateStructure(), $searchSubManager, $itemFactory);
    }
